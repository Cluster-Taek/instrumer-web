...
const PaymentPageContent = ({ solutionId }: { solutionId: number }) => {
    ...
    <div className="mx-auto px-20 py-12 w-full">
      <div className="flex flex-row gap-8">
        ...
        <div className="flex-1 flex flex-col gap-6 rounded-lg shadow-md bg-white p-6">
          {/* 주문 상세 내역 */}
          <OrderDetailSection solution={solution} />
        ...
        <div className="w-[400px]">
          <PaymentSummarySection price={solution.price} />
        </div>
      </div>
    </div>
  );
...
const PaymentPage = () => {
  ...
  return (
    <Suspense fallback={<PaymentPageSkeleton />}>
      <PaymentPageContent solutionId={solutionId} />
    </Suspense>
  );
};
