...
const HomeSolutionSection = () => {
  return (
    <section id="solution" className="flex w-full flex-col gap-16 px-24">
      <div className="flex flex-col items-center gap-3">
        <h1 className="text-center text-6xl tracking-tighter font-semibold" id="top">
          어떤
        ...
        {CATEGORY_OPTIONS.map((button) => (
          <li key={button.value}>
            <Link href={`/solutions?category=${button.value}`} className="flex flex-col items-center">
              <figure className="flex w-full flex-col items-center gap-7">
                ...
                <figcaption className="text-2xl font-medium tracking-tight">
